...
public class ExtentManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		// report
		// sparkReporter.config().setReportName("Functional Testing"); // name of the
		// report
		...
		extent.setSystemInfo("Project Name", "CBXProject_V3");
		extent.setSystemInfo("Tester Name", "Rangarajan");
