...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Celebratix Automation Report"); // Title of report
		sparkReporter.config().setReportName("Functional Testing"); // name of the report
		sparkReporter.config().setTheme(Theme.DARK);
		extent = new ExtentReports();
		extent.attachReporter(sparkReporter);
		extent.setSystemInfo("Application", "Staging.Celebratix");
		extent.setSystemInfo("ProjectName", "CBXProject_V3");
		extent.setSystemInfo("Tester", "Rangarajan");
